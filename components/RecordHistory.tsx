    ...
    return (
      <div className='bg-zinc-700 flex items-center justify-center pb-6'>
        <div className='bg-zinc-800 shadow-lg rounded-lg p-8 w-full text-center'>
          <h3 className='text-2xl font-bold mb-4 bg-gradient-to-r from-blue-500 via-sky-500 to-cyan-500 bg-clip-text text-transparent'>
  ...
  return (
    <div className='bg-zinc-700 p-6 '>
      <div className='bg-zinc-800 shadow-lg rounded-lg p-8 mx-auto'>
        <h3 className='text-2xl font-bold text-center mb-6 bg-gradient-to-r from-blue-500 via-sky-500 to-cyan-500 bg-clip-text text-transparent pb-6'>
          Sleep History
        </h3>
